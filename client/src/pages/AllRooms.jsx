...
const CheckBox = ({label, selected = false, onChange = () => {}})=>{
    return(
        <label className='flex gap-3 items-center cursor-pointer mt-1 text-sm'>
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-36 px-4 md:px-16 lg:px-24 xl:px-32'>
      <div >
        ...
        {filteredRooms.map((room)=>(
            <div className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-28 last:border-0'>
      ...
      {/* Filters */}
      <div className='bg-white w-64 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16'>
