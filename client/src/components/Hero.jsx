...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col gap-20 items-end justify-center px-6 md:px-16 text-white bg-[url("/src/assets/hotel-bg3.jpg")] bg-no-repeat bg-cover bg-center h-screen'>
      {/* <p className='bg-[#49b9ff]/50 px-3.5 py-1 rounded-full mt-20'>The Ulitimate Hotel Experience</p> */}
      <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-lg mt-4'>Discover Your Perfect Gateway Destination</h1>
      {/* <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exclusive hotels and resorts. Start your journey today.</p> */}
        ...
        <form onSubmit={onSearch} className='bg-teal-300 text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
