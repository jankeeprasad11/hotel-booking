...
const BookIcon = () => (
  ...
  <path stroke="currentColor" strokelinecap="round" strokelinejoin="round" strokewidth="2" d="M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v15H2 0 0-2 2Zm0a2 2 0 0 2 2h12m9 3v14m7 0v4"/>
</svg>
)
...
const Navbar = () => {
    ...
    return (
        ...
        <nav className={`fixed top-0 left-0  w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}>
            ...
            {/* Logo */}
            <Link to={'/'}>
                <img src={assets.updatedLogo} alt="logo" className={`h-9 ${isScrolled && "invert opacity-80"}`} />
            </Link>
